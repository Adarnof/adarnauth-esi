...
OAUTH_LOGIN_URL = getattr(settings, 'ESI_SSO_LOGIN_URL', OAUTH_URL + "/authorize/")
TOKEN_URL = getattr(settings, 'ESI_CODE_EXCHANGE_URL', OAUTH_URL + "/token")
TOKEN_VERIFY_URL = getattr(settings, 'ESI_TOKEN_EXCHANGE_URL', OAUTH_URL + "/verify")
